export function StorelyLogo(props: React.SVGProps<SVGSVGElement>) {
	return (
		<svg
...
// Keep CloudflareLogo as an alias for backward compatibility (will be removed in future)
export const CloudflareLogo = StorelyLogo;
